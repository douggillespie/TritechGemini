...
//		}
		...
		mi = PamModuleInfo.registerControlledUnit(GeminiControl.class.getName(), GeminiControl.unitType);
		mi.setToolTipText("Receive and process data from Gemini multibeam sonars");
		mi.setModulesMenuGroup(utilitiesGroup);
//		mi.setMaxNumber(1);
